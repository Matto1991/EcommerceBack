...
module.exports = async () => {
  const products = [
    //---------------------------------------------Living------------------------------------------------------
    {
      ...
      images: ["Living/TheLeonardSofa.png"],
      price: 2925,
      stock: 20,
      featured: true,
      categoryId: 1,
    ...
    },
    {
      ...
      images: ["Living/TheLeroyChair.webp"],
      price: 1575,
      stock: 20,
      featured: false,
      categoryId: 1,
    },
    {
      ...
      images: ["Living/TheVestryNestingTable.png"],
      price: 1275,
      stock: 20,
      featured: false,
      categoryId: 1,
    },
    {
      ...
      images: ["Living/TheFranklinBench.png"],
      price: 1775,
      stock: 20,
      featured: false,
      categoryId: 1,
    ...
    },
    {
      ...
      images: ["Bedroom/VarickChair.png"],
      price: 2150,
      stock: 20,
      featured: false,
      categoryId: 2,
    },
    {
      ...
      images: ["Bedroom/ThompsonCanopyBed.png"],
      price: 3750,
      stock: 20,
      featured: false,
      categoryId: 2,
    },
    {
      ...
      images: ["Bedroom/BoweryCoffeeTable.png"],
      price: 1675,
      stock: 20,
      featured: false,
      categoryId: 2,
    ...
    //------------------------------------ Dining
    {
      ...
      images: ["Dining/TheBedfordDininigTable.png"],
      price: 2450,
      stock: 20,
      featured: true,
      categoryId: 3,
    },
    {
      ...
      images: ["Dining/TheJaneDiningChair.png"],
      price: 745,
      stock: 20,
      featured: false,
      categoryId: 3,
    },
    {
      ...
      images: ["Dining/TheDelanceyStool.png"],
      price: 865,
      stock: 20,
      featured: false,
      categoryId: 3,
    },
    {
      ...
      images: ["Dining/TheCarlisleDiningTable.png"],
      price: 3450,
      stock: 20,
      featured: false,
      categoryId: 3,
    },
    {
      ...
      images: ["Dining/TheReadeConsoleTable.png"],
      price: 2475,
      stock: 20,
      featured: false,
      categoryId: 3,
    ...
    // ------------------------ Sets --------------------------
    {
      ...
      images: ["Sets/TheMorroNestingtables.png"],
      price: 2950,
      stock: 20,
      featured: true,
      categoryId: 4,
    },
    {
      ...
      images: ["Sets/SetMorroTable&Chains.png"],
      price: 4735,
      stock: 20,
      featured: false,
      categoryId: 4,
    },
    {
      ...
      images: ["Sets/SetReyesTable&Chains.png"],
      price: 7795,
      stock: 20,
      featured: false,
      categoryId: 4,
